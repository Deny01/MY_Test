namespace KReport.Controls
{
    ...
    public class ControlBox_Select
    {
        ...
        public ControlBox_Select(Control ctl)
        {
            for (int i = 0; i < 8; i++)
            {
                this.lbl[i] = new Label();
        ...
        public void HideHandles()
        {
            if (this.m_control != null)
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    ...
                    //this.lbl[i].BringToFront();
                    this.lbl[i].Visible = false;
                    if (null!=this.m_control.Parent && this.m_control.Parent.Controls.Contains(this.lbl[i]))
                    {
        ...
        public  void ShowHandles()
        {
            ...
            if (this.m_control != null)
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    if (null != this.m_control.Parent.Controls)
                    {
                        this.m_control.Parent.Controls.Add(this.lbl[i]);
                        this.lbl[i].BringToFront();
                    }
