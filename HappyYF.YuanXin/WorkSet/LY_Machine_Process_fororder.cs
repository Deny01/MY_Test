...
{
    public partial class LY_Machine_Process_fororder : Form
    {
        ...
        string nowpruductionOrder_num;

        public string NowpruductionOrder_num
        {
            get { return nowpruductionOrder_num; }
            set { nowpruductionOrder_num = value; }
        }

        public LY_Machine_Process_fororder()
        {
            InitializeComponent();
        }
        ...
        private void LY_Machine_Process_Load(object sender, EventArgs e)
        {
            ...
            this.groupBox1.Text ="跟单:"+nowpruductionOrder_num +" "+ nowitemno + ":加工工序";


            this.ly_manufacturing_procedure_selTableAdapter.Fill(this.lYMaterielRequirements.ly_manufacturing_procedure_sel);
            this.ly_machinepart_process_fororderTableAdapter.Fill(this.lYMaterielRequirements.ly_machinepart_process_fororder, nowitemno, nowpruductionOrder_num);
        ...
        private void ly_manufacturing_procedure_selDataGridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.ly_machinepart_process_fororderBindingSource.AddNew();
            ...
            this.ly_machinepart_processDataGridView.CurrentRow.Cells["跟单编号"].Value = nowpruductionOrder_num;

            this.ly_machinepart_processDataGridView.EndEdit();
            this.ly_machinepart_process_fororderBindingSource.EndEdit();

            this.ly_machinepart_process_fororderTableAdapter.Update(this.lYMaterielRequirements.ly_machinepart_process_fororder);
        ...
        private void 删除供应商ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                this.ly_machinepart_process_fororderBindingSource.RemoveCurrent();
            ...
            if (this.formState != "View" && null !=dc .CurrentRow )
            {
                ...
                if (keyData == Keys.Enter)
                {
                    ...
                    else  if (13 == dc.CurrentCell.ColumnIndex && dc.CurrentRow.Index != (dc.RowCount - 1))
                    {
                        ...
                        dc.EndEdit();
                        ly_machinepart_process_fororderBindingSource.EndEdit();

                      

                       this.ly_machinepart_process_fororderTableAdapter.Update(this.lYMaterielRequirements.ly_machinepart_process_fororder);

                       ly_machinepart_process_fororderBindingSource.Position = dc.CurrentRow.Index + 1;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            ly_machinepart_process_fororderBindingSource.Position = 0;
