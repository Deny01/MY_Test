...
{
    public partial class LY_Store_ProductIn : Form
    {
        public LY_Store_ProductIn()
        {
            InitializeComponent();
        }
        ...
        {
            this.ly_plan_productlistTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
        ...
        private void ly_material_plan_mainDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            if (null == this.ly_material_plan_mainDataGridView.CurrentRow) return ;
                    ...
                    this.ly_plan_productlistTableAdapter.Fill(this.lYStoreMange.ly_plan_productlist, planNum);
        ...
        {
            if (null == this.ly_material_plan_mainDataGridView.CurrentRow) return;
            if (null == ly_plan_productlistDataGridView.CurrentRow) return;

            string componentNum = this.ly_plan_productlistDataGridView.CurrentRow.Cells["物料编号"].Value.ToString();
            string planNum = this.ly_material_plan_mainDataGridView.CurrentRow.Cells["计划编号"].Value.ToString();
