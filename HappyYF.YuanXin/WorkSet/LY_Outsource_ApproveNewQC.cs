...
{
    public partial class LY_Outsource_ApproveNewQC : Form
    {

        string formState = "View";
        public LY_Outsource_ApproveNewQC()
        {
            InitializeComponent();
        }
        ...
        private void ly_purchase_contract_mainDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("审核" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if ("True" == dgv.CurrentRow.Cells["审核"].Value.ToString())
                {
                    ...
                    if (SQLDatabase.updateOutsourceContractmain(nowcontractcode, "审核", "0", DBNull.Value.ToString()))
                    {
                ...
                {
                    if (SQLDatabase.updateOutsourceContractmain(nowcontractcode, "审核", "1", SQLDatabase.nowUserName()))
                    {
        ...
        //    try
        //    {
        //        this.ly_outsource_contract_main11TableAdapter.Fill(this.lYOutsourceData.ly_outsource_contract_main11, new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(begindateToolStripTextBox.Text, typeof(System.DateTime))))), new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(enddateToolStripTextBox.Text, typeof(System.DateTime))))));
        //    }
