...
{
    public partial class LY_Quality_Control_OutsourceREC : Form
    {
        ...
        string nowaddcode = "";
        public LY_Quality_Control_OutsourceREC()
        {
            InitializeComponent();
        }
        ...
        private void LY_Machine_Load(object sender, EventArgs e)
        {
            ...
            {
                this.ly_outsource_contract_detailQClistBindingSource.Filter = "采购员='" + SQLDatabase.nowUserName() + "'";
            }
        ...
        private void bindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(ly_production_order_inspectionDataGridView.CurrentRow.Cells["结账合同"].Value.ToString()))
            {
            ...
            if (inspector!="" && inspector != SQLDatabase.nowUserName())
            {
        ...
        private void toolStripTextBox2_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                this.ly_outsource_contract_detailQClistBindingSource.Filter = " (" + dFilter+" )" + "and  ( 采购员 = '" + SQLDatabase.nowUserName() + "')";
            }
        ...
        private void 打印PToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            string nowCheckNum = ly_production_order_inspectionDataGridView.CurrentRow.Cells["质检单号"].Value.ToString();
            ...
            queryForm.Text = "中原精密外协收料送检单";

            queryForm.Printdata = this.lYOutsourceData ;

            queryForm.PrintCrystalReport = new LY_Purchase_rec_outsource();


            string selectFormula;

            selectFormula = "{ly_outsource_order_inspection.质检单号}  =   '" + nowCheckNum + "'";
