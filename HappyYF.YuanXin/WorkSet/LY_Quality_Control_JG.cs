...
{
    public partial class LY_Quality_Control_JG : Form
    {
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ly_production_order_detailDataGridView.CurrentRow.Cells["审批"].Value.ToString() != "True")
                {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                int detailId2 = int.Parse(this.ly_production_order_detailDataGridView.CurrentRow.Cells["orderdetail_id"].Value.ToString());

                this.ly_production_order_inspectionTableAdapter.Fill(this.lYQualityInspector.ly_production_order_inspection, detailId2);
        ...
        private void ly_production_order_inspectionDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            //string havecontract = dgv.CurrentRow.Cells["结账合同"].Value.ToString();
        ...
        private void 返修单查询ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (null == this.ly_production_order_inspectionDataGridView.CurrentRow) return;

            LY_Machine_RemakeQuery queryForm = new LY_Machine_RemakeQuery();
        ...
        private void 打印PToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            queryForm.PrintCrystalReport = new LY_ZJ();
            queryForm.ShowDialog();
        }
