...
{
    public partial class LY_StoreOutAnalysis : Form
    {
         private DataSet ds;
        BindingSource bindingSource2;

        public LY_StoreOutAnalysis()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
           ...
           // string sWhere = "  where ((a.service_number IS NULL) OR (a.service_number is not null)) ";
            ...
            if (this.checkBox8.Checked)
            {
                ...
                sWhere = sWhere + "  and ( a.out_date >= '" + dateTimePicker1.Text + "' and a.out_date <= '" + dateTimePicker2.Text + "') ";
            ...
            //////////////////////////////////////////////////
                ...
                {
                    header = header + " year(a.out_date) as 年份, month(a.out_date) as 月份, ";
                    ender = ender + " year(a.out_date),month(a.out_date),";
            ...
            //this.dataGridView1.Columns["出库金额"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            //this.dataGridView1.Columns["出库金额"].DefaultCellStyle.Format = "N2";
        ...
        private void AddSummationRow(BindingSource bs, DataGridView dg)
        {
            ...
            foreach (DataGridViewRow dr in dg.Rows)
            {
                ...
                //else
                //    sum_storemoney = sum_storemoney + decimal.Parse(dr.Cells["出库金额"].Value.ToString());
            ...
            //dg.CurrentRow.Cells["出库金额"].Value = sum_storemoney;
