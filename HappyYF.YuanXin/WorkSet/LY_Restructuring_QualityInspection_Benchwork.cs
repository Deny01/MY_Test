...
{
    public partial class LY_Restructuring_QualityInspection_Benchwork : Form
    {
        public LY_Restructuring_QualityInspection_Benchwork()
        {
            InitializeComponent();
        }
        ...
        private string GetMaxTaskInspection()
        {
            ...
            cmd.Parameters["@Production_mode"].Value = "QGZJ";
