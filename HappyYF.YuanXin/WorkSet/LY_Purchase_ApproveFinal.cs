...
{
    public partial class LY_Purchase_ApproveFinal : Form
    {

        string formState = "View";
        public LY_Purchase_ApproveFinal()
        {
            InitializeComponent();
        }
        ...
        private void LY_Machine_Load(object sender, EventArgs e)
        {
            ...
            this.ly_purchase_contract_main1TableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            ...
            this.ly_purchase_contract_main1TableAdapter.Fill(this.lYMaterielRequirements.ly_purchase_contract_main1, this.dateTimePicker1.Value, this.dateTimePicker2.Value.AddDays(1));

            AddSummationRow_New(ly_purchase_contract_main1BindingSource, ly_purchase_contract_mainDataGridView);
        ...
        private void SaveContract()
        {
            ...
            this.ly_purchase_contract_main1BindingSource.EndEdit();

            this.ly_purchase_contract_main1TableAdapter.Update(this.lYMaterielRequirements.ly_purchase_contract_main1);
        ...
        private void toolStripTextBox1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            this.ly_purchase_contract_main1BindingSource.Filter = "(" + filterString + ") or 合同编号='_合计'";
            AddSummationRow_New(ly_purchase_contract_main1BindingSource, ly_purchase_contract_mainDataGridView);
        }
        ...
        private void toolStripTextBox1_Enter(object sender, EventArgs e)
        {
            ...
            this.ly_purchase_contract_main1BindingSource.Filter = "";
            AddSummationRow_New(ly_purchase_contract_main1BindingSource, ly_purchase_contract_mainDataGridView);
        }
