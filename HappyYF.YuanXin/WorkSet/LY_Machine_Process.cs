...
{
    public partial class LY_Machine_Process : Form
    {
        ...
        private void LY_Machine_Process_Load(object sender, EventArgs e)
        {
            ...
            this.ly_inma0010_sortTableAdapter.Fill(this.lYMaterielRequirements.ly_inma0010_sort, "4","2");
        ...
        private void ly_manufacturing_procedure_selDataGridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (ly_inma0010_sortDataGridView.CurrentRow == null) return;
            ...
            decimal scale =decimal.Parse( this.ly_manufacturing_procedure_selDataGridView.CurrentRow.Cells["scale"].Value.ToString());
            ...
            this.ly_machinepart_processDataGridView.CurrentRow.Cells["工时因子"].Value = scale;
        ...
        {
            ExportDataGridviewTOExcell.ExportDataGridview(this.ly_machinepart_processDataGridView, true);
        }
    }
}
