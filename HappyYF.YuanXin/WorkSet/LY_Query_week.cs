...
{
    public partial class LY_Query_week : Form
    {
        private LY_SalseContract_StandardReport ownerForm;

        public LY_SalseContract_StandardReport OwnerForm
        {
            get { return ownerForm; }
            set { ownerForm = value; }
        }

        public LY_Query_week()
        {
            InitializeComponent();
        }
