...
{
    public partial class LY_Worker_Manage : Form
    {
        ...
        private void LY_Worker_Manage_Load(object sender, EventArgs e)
        {
            ...
            if ("01" == this.prod_code)
            {
                this.Text = "钳装人员管理";

            }
            else if ("02" == this.prod_code)
            {
                this.Text = "电装人员管理";

            }
            else if ("04" == this.prod_code)
            {
                this.Text = "机加人员管理";
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            ...
            ly_worker_listDataGridView.CurrentRow.Cells["部门"].Value = this.prod_code;
