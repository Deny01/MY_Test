...
{
    public partial class LY_add_Prepayment_NP : Form
    {
        public string nowsuppilercode;
        public LY_add_Prepayment_NP()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(dateTimePicker1.Text))
            {
                ...
                string sql = @"insert into ly_Prepayment_NP (supplier_code,pay_date,prepaymoney,pay_people ,remark)
