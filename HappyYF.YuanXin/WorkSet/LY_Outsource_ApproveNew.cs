...
{
    public partial class LY_Outsource_ApproveNew : Form
    {

        string formState = "View";
        public LY_Outsource_ApproveNew()
        {
            InitializeComponent();
        }
        ...
        private void SaveContract()
        {
            ...
            this.ly_outsource_contract_main11BindingSource.EndEdit();

            this.ly_outsource_contract_main11TableAdapter.Update(this.lYOutsourceData .ly_outsource_contract_main11 );
        ...
        private void ly_purchase_contract_mainDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("批准" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if ("True" == dgv.CurrentRow.Cells["批准"].Value.ToString())
                {
                    ...
                    if (SQLDatabase.updateOutsourceContractmain(nowcontractcode, "批准", "0", DBNull.Value.ToString()))
                    {
                ...
                {
                    if (SQLDatabase.updateOutsourceContractmain(nowcontractcode, "批准", "1", SQLDatabase.nowUserName()))
                    {
        ...
        private void toolStripTextBox3_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            this.ly_outsource_contract_main11BindingSource.Filter = "(" + filterString + ") or 合同编号='_合计'";
            AddSummationRow_New(ly_outsource_contract_main11BindingSource, ly_purchase_contract_mainDataGridView);
        }
        ...
        private void ly_purchase_contract_appendDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                string inspector = this.ly_purchase_contract_appendDataGridView.CurrentRow.Cells["审批人10"].Value.ToString();
                ...
                if ("True" == dgv.CurrentRow.Cells["审批"].Value.ToString())
                {
                    ...
                    dgv.CurrentRow.Cells["审批人10"].Value = DBNull.Value;
                ...
                else
                {
                    ...
                    dgv.CurrentRow.Cells["审批人10"].Value = SQLDatabase.nowUserName();
        ...
        private void ly_purchase_contract_detailDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("ignore_flag" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                {
                    // if (0 == decimal.Parse(dgv.CurrentRow.Cells["外协未到"].Value.ToString())) return;
                    ...
                    //dgv.CurrentRow.Cells["ignore_qty"].Value = dgv.CurrentRow.Cells["外协未到"].Value.ToString();
        ...
        private void toolStripButton8_Click(object sender, EventArgs e)
        {
            ...
            DataSort.SetSortColumns(this.lYOutsourceData.ly_outsource_contract_main11.Columns, ls);
            DataSort.ShowDialog();
            this.ly_outsource_contract_main11BindingSource.Sort = DataSort.GetSortString();
        }
