...
{
    public partial class LY_MaterialBom_Price_noVat_L : Form
    {
        ...
        public LY_MaterialBom_Price_noVat_L()
        {
            InitializeComponent();
            this.ly_item_allcost_NoVatLabTableAdapter.CommandTimeout = 0;
        }
        ...
        private void LY_MaterialBom_Load(object sender, EventArgs e)
        {
            ...
            this.ly_item_allcost_NoVatLabTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            ...
            ly_check_bomcodeTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            ly_check_bompriceTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
        ...
        private void MakeTreeView(System.Data.DataTable table, string ParentID, System.Windows.Forms.TreeNode PNode)
        {
        ...
        private void ly_inma0010DataGridView_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            string selAllString = "SELECT     parentno, itemno, cast(itemno +':'+itemname as char(30))  as itemname, qty_set,itemprice ,itemmoney,itemoutsourceall,itemoutsourcemachineall,assemblymoneyall, itemprocessingmoneyall ,isnull(itemmoney,0)+isnull(itemoutsourceall,0)+isnull(itemoutsourcemachineall,0)+isnull(itemprocessingmoneyall,0)+isnull(assemblymoneyall,0) as allmoney from f_BomExtend_price_novatLab('" + s + "',1) ORDER BY  id_num ";
        ...
        private static void Countmoney(string nowplannum)
        {
            ...
            cmd.CommandText = "LY_CalculateCostValuesLab";
        ...
        {
            NewFrm.Show(this);
            this.ly_item_allcost_NoVatLabTableAdapter.Fill(this.lYMaterialMange.ly_item_allcost_NoVatLab, this.parentNum);
        ...
        private void toolStripButton18_Click(object sender, EventArgs e)
        {
            ...
            string connString = SQLDatabase.Connectstring;
            //打开excel选择框
            OpenFileDialog frm = new OpenFileDialog();
            frm.Filter = "文本文件(*.txt)|*.txt";
            if (frm.ShowDialog() == DialogResult.OK)
            {
                ...
                StreamReader sTmp = new StreamReader(frm.FileName, System.Text.Encoding.Default);
                //// 一行一行读取
                while ((sStuName = sTmp.ReadLine()) != null)
                {
                    sStuName = sStuName.Trim().ToString();
                    DataRow dr = dt.NewRow();
                    dr["Code"] = sStuName;
                    if (sStuName.Length == 8)
                    {
                        dt.Rows.Add(dr);
                    }
                }
                if (dt.Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        myComm.CommandText = "delete from ly_check_bomcode";
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            string sqlInspection = @"insert into ly_check_bomcode (itemno) values ('" + dt.Rows[i]["Code"].ToString() + "')";
                        ...
                        myTran.Commit();
                        MessageBox.Show("成功导入" + dt.Rows.Count + "条!", "注意");
                    }
                    ...
                    finally
                    {
                        ...
                        myConn.Close();
                        ly_check_bomcodeTableAdapter.Fill(this.lYMaterialMange.ly_check_bomcode);
                    }
        ...
        private void toolStripButton23_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请先批量导入物料!", "注意"); return;
            ...
            {
                string sql = "delete from ly_check_bomprice"; ;
            ...
            {
                string wzbh = dataGridView2.Rows[i].Cells["itemno"].Value.ToString();


                NewFrm.Notify(this, "正在计算导出:  (" + wzbh + ")   成本");
                ...
                cmd.Parameters.Add("@wzbh", SqlDbType.VarChar);
                cmd.Parameters["@wzbh"].Value =wzbh;

                cmd.CommandText = "ly_check_bom_price";
                cmd.CommandType = CommandType.StoredProcedure; 
                cmd.Connection = sqlConnection1;
                cmd.CommandTimeout = 0;
                sqlConnection1.Open();
            ...
            this.ly_check_bompriceTableAdapter.Fill(this.lYMaterialMange.ly_check_bomprice);
            // 
            NewFrm.Hide(this);
        }
        ...
        {
            ExportDataGridviewTOExcellA.ExportDataGridview(this.dataGridView3, true);
