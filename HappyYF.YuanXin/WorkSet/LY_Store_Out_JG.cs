...
{
    public partial class LY_Store_Out_JG : Form
    {
        ...
        private void LY_Machine_Load(object sender, EventArgs e)
        {
            ...
            this.ly_production_order_materialrequisitionOutstoreTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;

            this.ly_store_out_JGTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;

            this.ly_production_order_materialrequisitionOutstoreTableAdapter.Fill(this.lYMaterielRequirements.ly_production_order_materialrequisitionOutstore, DateTime.Parse(this.dateTimePicker1.Text).Date, DateTime.Parse(this.dateTimePicker2.Text).Date);
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                else
                {
                    ...
                    this.ly_store_outDataGridView.CurrentRow.Cells["出库类别"].Value = "机加生产";
        ...
        private void SaveChanged()
        {
            ...
            if (null != this.ly_production_order_materialrequisitionDataGridView.CurrentRow)
            {
                request_Id = int.Parse(this.ly_production_order_materialrequisitionDataGridView.CurrentRow.Cells["request_Id"].Value.ToString());
            }
            else
            {
                request_Id = 0;
            ...
            ////////////////////////////////////
             ...
             //this.ly_store_in_JGTableAdapter.Fill(this.lYQualityInspector.ly_store_in_JG, nowmaterialrequisitionnum);

            this.ly_production_order_materialrequisitionOutstoreTableAdapter.Fill(this.lYMaterielRequirements .ly_production_order_materialrequisitionOutstore, DateTime.Parse(this.dateTimePicker1.Text).Date, DateTime.Parse(this.dateTimePicker2.Text).Date);

            this.ly_production_order_materialrequisitionOutstoreBindingSource.Position = this.ly_production_order_materialrequisitionOutstoreBindingSource.Find("id", request_Id);
        ...
        private string  GetnowRemark(DataGridView sender)
        {
            DataGridView dgv = sender;
            ...
            if ("棒料" == nowgeometry)
            {
                ...
                nowremark = decimal.Parse(dgv.CurrentRow.Cells["diameter"].Value.ToString()).ToString("#") + "*"
                           + decimal.Parse(dgv.CurrentRow.Cells["length"].Value.ToString()).ToString("#")
                           + "*" + decimal.Parse(dgv.CurrentRow.Cells["out_count"].Value.ToString()).ToString("#.00");
            ...
            if ("板料" == nowgeometry)
            {
                ...
                nowremark = decimal.Parse(dgv.CurrentRow.Cells["length"].Value.ToString()).ToString("#")
                    + "*" + decimal.Parse(dgv.CurrentRow.Cells["width"].Value.ToString()).ToString("#")
                    + "*" + decimal.Parse(dgv.CurrentRow.Cells["height"].Value.ToString()).ToString("#")
                    + "*" + decimal.Parse(dgv.CurrentRow.Cells["out_count"].Value.ToString()).ToString("#.00");
        ...
        private void SetFormState(string state)
        {
            ...
            {
                this.formState = "View";
                this.ly_production_order_materialrequisitionDataGridView.Enabled = false;
            ...
            {
                this.formState = "Edit";
                this.ly_production_order_materialrequisitionDataGridView.Enabled = true;
        ...
        private void ly_production_order_materialrequisitionDataGridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                string nowitemno = this.ly_production_order_materialrequisitionDataGridView.CurrentRow.Cells["物料编号5"].Value.ToString();

                if (0 <= this.ly_store_out_JGBindingSource.Find("物料编号", nowitemno))
                {
                    MessageBox.Show("已经选择,修改数量即可...", "注意");
                ...
                if (hadget_count >= request_count && 0 < request_count)
                {
                ...
                else if (hadget_count <= request_count && 0 > request_count)
                {

                    MessageBox.Show("该领料单退料数量已全部退完,不能继续退料", "注意");
                ...
                else
                {
                    if (store_count > 0)
                    {
                        ...
                        {
                            this.ly_store_outDataGridView.CurrentRow.Cells["领料数量"].Value = store_count;
                        }
                        this.ly_store_outDataGridView.CurrentRow.Cells["领料人"].Value = this.ly_production_order_materialrequisitionDataGridView.CurrentRow.Cells["姓名5"].Value;


                        this.ly_store_outDataGridView.CurrentRow.Cells["出库日期"].Value = SQLDatabase.GetNowdate();

                        this.ly_store_outDataGridView.CurrentRow.Cells["发料人"].Value = SQLDatabase.nowUserName();
                        this.ly_store_outDataGridView.CurrentRow.Cells["领料部门"].Value = "04";



                        this.ly_store_outDataGridView.CurrentRow.Cells["备注"].Value = GetnowRemark(this.ly_production_order_materialrequisitionDataGridView);
                        this.ly_store_outDataGridView.CurrentRow.Cells["出库类别"].Value = "机加生产";
                    }
        ...
        //    try
        //    {
        //        this.ly_store_outnumDailyTableAdapter.Fill(this.lYMaterielRequirements.ly_store_outnumDaily, new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(begin_dateToolStripTextBox.Text, typeof(System.DateTime))))), new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(end_dateToolStripTextBox.Text, typeof(System.DateTime))))));
        //    }
        //    catch (System.Exception ex)
        //    {
        //        System.Windows.Forms.MessageBox.Show(ex.Message);
