...
{
    public partial class LY_Salescontract_Approve : Form
    {
        ...
        public LY_Salescontract_Approve()
        {
            InitializeComponent();
        }
        ...
        private void ly_plan_getmaterialDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("转赠批准" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if ("True" == dgv.CurrentRow.Cells["转赠批准"].Value.ToString())
                {
                    dgv.CurrentRow.Cells["转赠批准"].Value = "False";
                    dgv.CurrentRow.Cells["转赠批准人"].Value = DBNull.Value;
                  
                }
                else
                {

                    dgv.CurrentRow.Cells["转赠批准"].Value = "True";
                    dgv.CurrentRow.Cells["转赠批准人"].Value = SQLDatabase.nowUserName();
