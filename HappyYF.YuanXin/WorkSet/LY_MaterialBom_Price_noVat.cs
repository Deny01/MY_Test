...
{
    public partial class LY_MaterialBom_Price_noVat : Form
    {
        ...
        public LY_MaterialBom_Price_noVat()
        {
            InitializeComponent();
        ...
        private void ly_inma0010DataGridView_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            string selAllString = "SELECT     parentno, itemno, cast(itemno +':'+itemname as char(30))  as itemname,cast(qty_set as decimal(18,3)) as qty_set,itemprice ,itemmoney,assemblymoney,standardsetmoney,itemprocessingmoney,operation_cost,isnull(itemmoney,0)+isnull(itemprocessingmoney,0)+isnull(assemblymoney,0)+isnull(standardsetmoney,0)+isnull(operation_cost,0) as allmoney from f_BomExtend_price_novat('" + s + "',1) ORDER BY  id_num ";
        ...
        private static void Countmoney(string nowplannum)
        {
            ...
            string updstrclear = " update ly_inma0010  " +
                          "  set mprice_novat=0,pprice_novat=0,assembly_price_novat=0,standardset_price_novat=0,operation_cost_novat=0 "
        ...
        private void toolStripButton10_Click(object sender, EventArgs e)
        {
          ...
          ///*  ExportD*/ataGridviewTOExcellA.ExportExcel(nowplannum + " " + nowtype, this.ly_item_allcost_NoVatDataGridView, savepath + "\\" + nowplannum + ".xls");
