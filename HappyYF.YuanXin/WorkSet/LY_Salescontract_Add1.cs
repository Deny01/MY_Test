...
{
    public partial class LY_Salescontract_Add1 : Form
    {
        ...
        private void SaveData()
        {
            ...
            this.ly_sales_business_singleBindingSource.EndEdit();
            this.ly_sales_business_singleTableAdapter.Update(this.lYSalseMange.ly_sales_business_single);
        ...
        private void LY_MaterialAdd_Load(object sender, EventArgs e)
        {
            ...
            this.ly_sales_business_singleTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            ...
            if ("增加" == runmode)
            {
                    ...
                    this.ly_sales_business_singleBindingSource.AddNew();
            ...
            else
            {
                ...
                this.ly_sales_business_singleTableAdapter.Fill(this.lYSalseMange.ly_sales_business_single, this.contractinner_code);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.contractinner_code = this.合同编码TextBox.Text;
            ...
            catch (SqlException sqle)
            {
                ...
                MessageBox.Show(sqle.Message+ "业务编号重复...", "注意");
