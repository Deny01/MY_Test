...
{
    public partial class LY_Receive_Repair_daily : Form
    {
        ...
        public LY_Receive_Repair_daily()
        {
            InitializeComponent();
        ...
        private void Yonghu_Load(object sender, EventArgs e)
        {
            ...
            this.ly_store_outnum_MaintenanceTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            this.ly_store_out_MaintenanceTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;

            
            this.ly_sales_receive_repairfee_BillNewTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
        ...
        private void toolStripButton8_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(ly_sales_receiveDataGridView.CurrentRow.Cells["开票日期"].Value.ToString()))
            {
        ...
        private void ly_sales_receiveDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            ...
            int nowreceiveId =Int32.Parse ( ly_sales_receiveDataGridView.CurrentRow.Cells["id_receive"].Value.ToString());

            if ("宁波维修" == ly_sales_receiveDataGridView.CurrentRow.Cells["维修部门"].Value.ToString())
            {
                this.ly_store_out_MaintenanceTableAdapter.Fill(this.lYSalseRepair.ly_store_out_Maintenance, nowreceiveId);
                this.ly_store_outnum_MaintenanceTableAdapter.Fill(this.lYSalseRepair.ly_store_outnum_Maintenance, nowreceiveId);
            }
            else
            {
                this.ly_store_out_MaintenanceTableAdapter.Fill(this.lYSalseRepair.ly_store_out_Maintenance, -9);
                this.ly_store_outnum_MaintenanceTableAdapter.Fill(this.lYSalseRepair.ly_store_outnum_Maintenance, -9);
            }
        ...
        private void ly_sales_receive_itemDetailDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("维修费" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    if (!string.IsNullOrEmpty(dgv.CurrentRow.Cells["warranty"].Value.ToString()) && !string.IsNullOrEmpty(dgv.CurrentRow.Cells["delivery"].Value.ToString()))
                    {
                        int war_t = int.Parse(dgv.CurrentRow.Cells["warranty"].Value.ToString());
                        int out_t = int.Parse(dgv.CurrentRow.Cells["delivery"].Value.ToString());
                        if (out_t <= war_t)
                        {
                            string caption = "提示...";
                            MessageBoxButtons buttons = MessageBoxButtons.YesNo;
                            DialogResult result;
                            string message = "当前产品在保修期内，确定继续添加维修费吗?";
                            result = MessageBox.Show(message, caption, buttons,
                            MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
            ...
            if ("itemno_repname" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    dgv.CurrentRow.Cells["itemno_repname"].Value = queryForm.NewValue;


                }
                else
                {
                    dgv.CurrentRow.Cells["itemno_repname"].Value = DBNull.Value;
        ...
        private void ly_sales_receive_itemDetail_repairDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (!SQLDatabase.CheckHaveRight(SQLDatabase.NowUserID, "维修数量设置"))
            {
                MessageBox.Show("无维修单价设置权限,不能修改数据...", "注意");
                return;
            }
            ...
            if ("单价" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    else
                    {
                        if (!SQLDatabase.CheckHaveRight(SQLDatabase.NowUserID, "维修数量设置"))
                        {
                            MessageBox.Show("无维修单价设置为0权限,不能修改数据...", "注意");
            ...
            if ("收费数量" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (!SQLDatabase.CheckHaveRight(SQLDatabase.NowUserID, "维修数量设置"))
                {
                    MessageBox.Show("无维修数量设置权限,不能修改数据...", "注意");
                    return;
                }
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    dgv.CurrentRow.Cells["收费数量"].Value = queryForm.NewValue;
        ...
        private void ly_sales_receiveDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            string nowclient_code = dgv.CurrentRow.Cells["客户编码"].Value.ToString();

            string nowreceiveCode = dgv.CurrentRow.Cells["收件编号"].Value.ToString();



            if ("客户联系人" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    string sql = "update ly_sales_client_forreceive set salesclient_contacts='" + queryForm.NewValue + "' where receive_code='"+ nowreceiveCode + "'";
                    int k = 0;
                    ...
                    if (k > 0)
                    {
                        dgv.CurrentRow.Cells["客户联系人"].Value = queryForm.NewValue;
            ...
            if ("客户电话" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    string sql = "update ly_sales_client_forreceive set salesclient_phone='" + queryForm.NewValue + "' where receive_code='" + nowreceiveCode + "'";
                    int k = 0;
                    using (SqlConnection con = new SqlConnection(SQLDatabase.Connectstring))
                    {
                    ...
                    if (k > 0)
                    {
                        dgv.CurrentRow.Cells["客户电话"].Value = queryForm.NewValue;
                        this.ly_sales_receiveBindingSource.EndEdit();
                        this.ly_sales_receiveTableAdapter.Update(this.lYSalseMange2.ly_sales_receive);
                        //MessageBox.Show("修改成功...", "注意");
                    }
            ...
            ///////////////////////////////////////////////////////////////
            if ("折扣金额" == dgv.CurrentCell.OwningColumn.Name)
            {

               

                if (!SQLDatabase.CheckHaveRight(SQLDatabase.NowUserID, "维修折扣批准"))
                {
                    MessageBox.Show("无维修折扣批准权限...", "注意");
                    return;
                }
                ...
                decimal nowrealmoney;

                if ("" != dgv.CurrentRow.Cells["真实金额"].Value.ToString())
                {
                    nowrealmoney = decimal.Parse(dgv.CurrentRow.Cells["真实金额"].Value.ToString());
                }
                else
                {
                    return;
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    if ("" != queryForm.NewValue)
                    {
                        nowrealdis = (nowrealmoney - decimal.Parse(queryForm.NewValue)) / nowrealmoney*100;
                    }
                    else
                    {
                        nowrealdis = 0;
                    ...
                    decimal nowleaderdiscount = SQLDatabase.nowUserRepairdiscount();

                    if (nowrealdis < nowleaderdiscount)
                    {
                        MessageBox.Show("折扣权限不够,操作取消...", "注意");
                        return;

                    }
                     
                    
                    dgv.CurrentRow.Cells["折扣金额"].Value = queryForm.NewValue;

                    dgv.CurrentRow.Cells["合同金额"].Value = nowrealmoney - decimal.Parse(queryForm.NewValue);

                    dgv.CurrentRow.Cells["折扣率"].Value = nowrealdis;

                  

                    dgv.CurrentRow.Cells["折扣批准"].Value = SQLDatabase.nowUserName();

                    dgv.CurrentRow.Cells["折扣批准日期"].Value = SQLDatabase.GetNowdate();
                ...
                else
                {
                    ...
                    dgv.CurrentRow.Cells["折扣金额"].Value = DBNull.Value;

                    dgv.CurrentRow.Cells["合同金额"].Value = nowrealmoney;

                    dgv.CurrentRow.Cells["折扣率"].Value = DBNull.Value;



                    dgv.CurrentRow.Cells["折扣批准"].Value = DBNull.Value;

                    dgv.CurrentRow.Cells["折扣批准日期"].Value = DBNull.Value;
            ...
            ///////////////////////////////////////////////////////////////
            if ("折扣率" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    if ("" != queryForm.NewValue)
                    {
                        nowrealdis = decimal.Parse(queryForm.NewValue);
                    }
                    else
                    {
                        nowrealdis = 0;
                    ...
                    dgv.CurrentRow.Cells["折扣率"].Value = queryForm.NewValue;

                    dgv.CurrentRow.Cells["折扣金额"].Value = nowrealmoney * (1 - nowrealdis/100);



                    dgv.CurrentRow.Cells["合同金额"].Value = nowrealmoney - nowrealmoney * (1 - nowrealdis/100);
            ...
            ///////////////////////////////////////////////////////////////
            if ("包装运输费" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    dgv.CurrentRow.Cells["包装运输费"].Value = queryForm.NewValue;
                ...
                else
                {
                    ...
                    dgv.CurrentRow.Cells["包装运输费"].Value = DBNull.Value;
            ...
            ///////////////////////////////////////////////////////////////
            if ("清单日期" == dgv.CurrentCell.OwningColumn.Name)
            {
                if (!SQLDatabase.CheckHaveRight(SQLDatabase.NowUserID, "维修数量设置"))
                {
                    MessageBox.Show("无重设清单日期权限,不能修改数据...", "注意");
                    return;
                }
                ...
                if (queryForm.NewValue != "")
                {
                    dgv.CurrentRow.Cells["清单日期"].Value = queryForm.NewValue;
                    dgv.CurrentRow.Cells["维修清单"].Value = Get_Repairbill_Code(queryForm.NewValue);
            ...
            ///////////////////////////////////////////////////////////////
            if ("company_name" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.Result != "")
                {
                    dgv.CurrentRow.Cells["company_code"].Value = queryForm.Result;
                    dgv.CurrentRow.Cells["company_name"].Value = queryForm.Result1;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
            ...
            if ("维修合同编号" == dgv.CurrentCell.OwningColumn.Name)
            {
                
                if ( ! SQLDatabase.CheckHaveRight(SQLDatabase .NowUserID,"维修合同手工编号"))
                {
                    return;
                }
                ...
                if (queryForm.NewValue != "")
                {
                    dgv.CurrentRow.Cells["维修合同编号"].Value = queryForm.NewValue;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
                ...
                {
                    dgv.CurrentRow.Cells["维修合同编号"].Value = DBNull.Value;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
                    dgv.CurrentRow.Cells["合并开票"].Value = "False";
                    //dgv.CurrentRow.Cells["approve_flag"].Value = "False";
                    this.ly_sales_receiveBindingSource.EndEdit();
                    this.ly_sales_receiveTableAdapter.Update(this.lYSalseMange2.ly_sales_receive);
            ...
            if ("客户联系人" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    string nowitem = "salesclient_contacts";

                    UpdateClientInfo(nowclient_code, queryForm.NewValue, nowitem);
                ...
                {
                    dgv.CurrentRow.Cells["客户联系人"].Value = DBNull.Value;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
            ...
            if ("客户电话" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    string nowitem = "salesclient_phone";
                ...
                {
                    dgv.CurrentRow.Cells["客户电话"].Value = DBNull.Value;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
            ...
            if ("客户传真" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    dgv.CurrentRow.Cells["客户传真"].Value = queryForm.NewValue;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
                ...
                {
                    dgv.CurrentRow.Cells["客户传真"].Value = DBNull.Value;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
            ...
            if ("客户地址" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    dgv.CurrentRow.Cells["客户地址"].Value = queryForm.NewValue;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
                    ...
                    string nowitem = "salesclient_address";
                ...
                {
                    dgv.CurrentRow.Cells["客户地址"].Value = DBNull.Value;
                    //dgv.CurrentRow.Cells["discount_money"].Value = DBNull.Value;
        ...
        private void toolStripButton27_Click_1(object sender, EventArgs e)
        {
            ...
            if ("True" != ly_sales_receiveDataGridView.CurrentRow.Cells["出库完成"].Value.ToString()
                &&
                "宁波维修" == ly_sales_receiveDataGridView.CurrentRow.Cells["维修部门"].Value.ToString()
                )
            {
                MessageBox.Show("出库未完成,不能报价...", "注意");
                return;
            }
        ...
        private void toolStripButton5_Click(object sender, EventArgs e)
        {
            ...
            if (null == ly_sales_receiveDataGridView.CurrentRow) return;
            if (!string.IsNullOrEmpty(ly_sales_receiveDataGridView.CurrentRow.Cells["客户名称"].Value.ToString()))
            {

                if (ly_sales_receiveDataGridView.CurrentRow.Cells["客户名称"].Value.ToString().Contains("客户收件")
                    || ly_sales_receiveDataGridView.CurrentRow.Cells["客户名称"].Value.ToString().Contains("收件"))
                {
                    MessageBox.Show("清单名称不符合规范...", "注意");
                    return;
                }
            ...
            for (int j = 0; j < ly_sales_receive_itemsDataGridView.Rows.Count; j++)
            {
                this.ly_sales_receive_itemsBindingSource.Position =j;

                for (int i = 0; i < ly_sales_receive_itemDetailDataGridView.Rows.Count; i++)
                {
                    if (string.IsNullOrEmpty(ly_sales_receive_itemDetailDataGridView.Rows[i].Cells["financial_code"].Value.ToString())
                        || string.IsNullOrEmpty(ly_sales_receive_itemDetailDataGridView.Rows[i].Cells["financial_name"].Value.ToString()))
                    {
                        MessageBox.Show("项目明细中财务大类为必填...", "注意");
                        return;
                    }
                }
            }
            ...
            if (string.IsNullOrEmpty( this.ly_sales_receiveDataGridView.CurrentRow.Cells["清单日期"].Value.ToString ()))
            {
                ...
                this.ly_sales_receiveDataGridView.CurrentRow.Cells["清单提交"].Value = SQLDatabase.nowUserName();
        ...
        private void ly_sales_receive_repairfeeDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                if (!string.IsNullOrEmpty(ly_sales_receiveDataGridView.CurrentRow.Cells["维修清单"].Value.ToString()))
                {
                    MessageBox.Show("清单已开,不能修改数据...", "注意");
                    return;
            ...
            if ("2"!=dgv.CurrentRow.Cells["idz"].Value.ToString())
            {
                MessageBox.Show("只能修改换件单价...", "注意");
                return;

            }

            if ("单价z" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    //dgv.CurrentRow.Cells["单价z"].Value = queryForm.NewValue;
                    ...
                    string nowreceiveCode = ly_sales_receiveDataGridView.CurrentRow.Cells["收件编号"].Value.ToString();
                    string nowitemno = dgv.CurrentRow.Cells["编码z"].Value.ToString();

                    string updstr = " update ly_sales_receive_itemDetail_repair " +
                                    " set ly_sales_receive_itemDetail_repair.item_price=" + queryForm.NewValue +
                                    " FROM dbo.ly_sales_receive_itemDetail_repair AS a LEFT OUTER JOIN " +
                                    " dbo.ly_sales_receive_itemDetail AS b ON a.parent_id = b.id LEFT OUTER JOIN " +
                                    " dbo.ly_sales_receive_items AS c ON b.parent_id = c.id " +
                                    " where c.receive_code='" + nowreceiveCode + "' and a.ori_itemno='" + nowitemno + "'";
                ...
                string nowreceiveCode1 = ly_sales_receiveDataGridView.CurrentRow.Cells["收件编号"].Value.ToString();

                this.ly_sales_receive_repairfeeTableAdapter.Fill(this.lYSalseMange2.ly_sales_receive_repairfee, nowreceiveCode1);
                this.ly_sales_receive_repairfee_BillTableAdapter.Fill(this.lYSalseMange2.ly_sales_receive_repairfee_Bill, nowreceiveCode1);
        ...
        private void ly_sales_receive_itemsDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void toolStripButton10_Click(object sender, EventArgs e)
        {
            ...
            //this.ly_sales_receive_repairfee_BillTableAdapter.Fill(this.lYSalseMange2.ly_sales_receive_repairfee_Bill, nowreceiveCode);
            this.ly_sales_receive_repairfee_BillNewTableAdapter.Fill(this.lYSalseMange2.ly_sales_receive_repairfee_BillNew, nowreceiveCode);
            ly_sales_receiveDataGridView.CurrentCell.Value.ToString();
            ...
            {
                queryForm.Text = "中原精密维修清单";
                queryForm.PrintCrystalReport = new LY_sales_repair_QdNew();
            }
 
            string selectFormula;

            selectFormula = "not {ly_sales_receive_repairfee_BillNew.免费} and {ly_sales_receive_repairfee_BillNew.金额}<>0 ";
            queryForm.PrintCrystalReport.DataDefinition.RecordSelectionFormula = selectFormula;
        ...
        private void toolStripButton11_Click(object sender, EventArgs e)
        {
            ...
            string str = this.ly_sales_receiveDataGridView.CurrentRow.Cells["收件编号"].Value.ToString();
            LY_WxExcelRep queryForm = new LY_WxExcelRep();

            queryForm.rece_code = str;
        ...
        private void toolStripButton17_Click(object sender, EventArgs e)
        {
            ...
            {
                queryForm.Text = "中原精密维修合同";
                queryForm.PrintCrystalReport = new LY_sales_repair_Ht2();
            }
        ...
        private void toolStripButton18_Click(object sender, EventArgs e)
        {
            ...
            {
                queryForm.Text = "中原精密维修合同";
                queryForm.PrintCrystalReport = new LY_sales_repair_Htold();
            }
        ...
        private void toolStripButton19_Click(object sender, EventArgs e)
        {
            ...
            {
                queryForm.Text = "中原精密维修清单";
                queryForm.PrintCrystalReport = new LY_sales_repair_QdNewold();
            }
        ...
        private void 维修物料出库ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if ("宁波维修" != ly_sales_receiveDataGridView.CurrentRow.Cells["维修部门"].Value.ToString())
            {
            ...
            if (result == DialogResult.Yes)
            {
                string receive_code = this.ly_sales_receiveDataGridView.CurrentRow.Cells["收件编号"].Value.ToString();
                string repair_sector_name = this.ly_sales_receiveDataGridView.CurrentRow.Cells["维修部门"].Value.ToString();
                ...
                CountStoreOut_External(receive_code, repair_sector_name);
                //this.ly_material_plan_detailTableAdapter.Fill(this.lYPlanMange.ly_material_plan_detail, parentId);
        ...
        private void CountStoreOut_External(string receive_code,string repair_sector_name)
        {
            ...
            cmd.Parameters["@receive_code"].Value = receive_code;



            cmd.Parameters.Add("@repair_sector_name", SqlDbType.VarChar);
            cmd.Parameters["@repair_sector_name"].Value = repair_sector_name;



            cmd.CommandText = "LY_store_out_Maintenance_external";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = sqlConnection1;
        ...
        private void toolStripButton20_Click(object sender, EventArgs e)
        {
            ...
            queryForm.PrintCrystalReport = new LY_Lingliaodan_WXNB();
        ...
        //    try
        //    {
        //        this.ly_store_out_MaintenanceTableAdapter.Fill(this.lYSalseRepair.ly_store_out_Maintenance, new System.Nullable<int>(((int)(System.Convert.ChangeType(receive_IdToolStripTextBox.Text, typeof(int))))));
        //        this.ly_store_outnum_MaintenanceTableAdapter.Fill(this.lYSalseRepair.ly_store_outnum_Maintenance,
        //    }
        ...
        //    try
        //    {
        //        this.ly_store_outnum_MaintenanceTableAdapter.Fill(this.lYSalseRepair.ly_store_outnum_Maintenance, new System.Nullable<int>(((int)(System.Convert.ChangeType(receive_IdToolStripTextBox.Text, typeof(int))))));
        //    }
        //    catch (System.Exception ex)
        //    {
        //        System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        //    try
        //    {
        //        this.ly_store_outnumTableAdapter.Fill(this.lYSalseRepair.ly_store_outnum, receive_codeToolStripTextBox.Text, worknameToolStripTextBox.Text, yonghu_codeToolStripTextBox.Text);
        //    }
        //    catch (System.Exception ex)
        //    {
        //        System.Windows.Forms.MessageBox.Show(ex.Message);
