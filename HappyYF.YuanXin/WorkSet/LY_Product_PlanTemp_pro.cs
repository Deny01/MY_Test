...
{
    public partial class LY_Product_PlanTemp_pro  : Form
    {
         string formState = "View";
         string tempState = "View";
         int nowTempRow;

         public LY_Product_PlanTemp_pro()
        {
            InitializeComponent();
        }
        ...
        private string GetMaxPlanCode()
        {
            ...
            cmd.Parameters["@Plan_mode"].Value = "SCPT";
        ...
        private void bindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("已有生产配套物料记录，不能删除(实需删除，请先删除该计划的物料记录)", "注意");
                return;
