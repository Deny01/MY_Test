...
{
    public partial class LY_sales_outInformquery : Form
    {
        private LY_Store_Out_Sales ownerForm;

        public LY_Store_Out_Sales OwnerForm
        {
            get { return ownerForm; }
            set { ownerForm = value; }
        }

        public LY_sales_outInformquery()
        {
            InitializeComponent();
        }
        ...
        private void LY_sales_outInform_Load(object sender, EventArgs e)
        {
            ...
            this.ly_inform_queryforstoreTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            this.ly_inform_queryforstoreTableAdapter.Fill(this.lYSalseRepair.ly_inform_queryforstore, SQLDatabase.NowUserID, this.dateTimePicker1.Value, this.dateTimePicker2.Value.AddDays(1));
        ...
        private void ly_inform_recordDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
           // return;
            ...
            //}
            ////////////////////////////////////////////////////////////////////////合同编号
            if ("依赖书号1" == dgv.CurrentCell.OwningColumn.Name)
            {

                if (!string.IsNullOrEmpty(dgv.CurrentRow.Cells["依赖书号1"].Value.ToString()) && !string.IsNullOrEmpty(dgv.CurrentRow.Cells["合同编号1"].Value.ToString()))
                {
                    string nowplannum = dgv.CurrentRow.Cells["依赖书号1"].Value.ToString();
                    string nowcontractnum = dgv.CurrentRow.Cells["合同编号1"].Value.ToString();
                    string nowinnercode = dgv.CurrentRow.Cells["清单编号1"].Value.ToString();
                    this.ownerForm.Find_planlocation(nowplannum, nowinnercode);
                }
                return;
        ...
        //    try
        //    {
        //        this.ly_inform_queryforstoreTableAdapter.Fill(this.lYSalseRepair.ly_inform_queryforstore, informpersoncodeToolStripTextBox.Text, new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(begindateToolStripTextBox.Text, typeof(System.DateTime))))), new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(enddateToolStripTextBox.Text, typeof(System.DateTime))))));
        //    }
        //    catch (System.Exception ex)
        //    {
        //        System.Windows.Forms.MessageBox.Show(ex.Message);
