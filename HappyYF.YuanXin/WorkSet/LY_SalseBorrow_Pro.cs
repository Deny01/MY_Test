...
{
    public partial class LY_SalseBorrow_Pro : Form
    {
        ...
        private void Yonghu_Load(object sender, EventArgs e)
        {
            ...
            this.ly_sales_borrow_dateTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
           

            this.ly_sales_borrow_clientBindingSource.Filter = " 提交=1 ";

            this.dateTimePicker4.Text = DateTime.Today.AddMonths(-3).Date.ToString();
            this.dateTimePicker3.Text = DateTime.Today.AddDays(1).Date.ToString();

           this.ly_sales_borrow_dateTableAdapter.Fill(this.lYSalseMange2.ly_sales_borrow_date,  this.dateTimePicker4.Value, this.dateTimePicker3.Value);
        ...
        private void ly_sales_clientDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            if (null == ly_sales_clientDataGridView.CurrentRow) 
            {
                ...
                this.ly_sales_borrow_clientTableAdapter.Fill(this.lYSalseMange.ly_sales_borrow_client, "");
                return;
            }
        ...
        private void toolStripTextBox6_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            filterString = GetDataGridviewMultiFilterString.DGVMultiFilterString(this.ly_sales_borrow_dateDataGridView, this.toolStripTextBox6.Text);


            this.ly_sales_borrow_dateBindingSource.Filter = filterString;
        }
        ...
        private void toolStripTextBox6_Enter(object sender, EventArgs e)
        {
            ...
            this.ly_sales_borrow_dateBindingSource.Filter = "";
        }
        ...
        private void ly_sales_borrowDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("True" == dgv.CurrentRow.Cells["营业发货j"].Value.ToString())
            {
                MessageBox.Show("借用单已经发货,不能修改数据...", "注意");
                return;
            ...
            if ("生产审批j" == dgv.CurrentCell.OwningColumn.Name)
            {
                if ("True" != dgv.CurrentRow.Cells["批准j"].Value.ToString())
                {
                    MessageBox.Show("借用单未经公司批准,生产不能审批...", "注意");
                    return;
                ...
                if ("True" == dgv.CurrentRow.Cells["生产审批j"].Value.ToString())
                {
                    ...
                    dgv.CurrentRow.Cells["生产审批人j"].Value = DBNull .Value ;
                ...
                else
                {
                    ...
                    dgv.CurrentRow.Cells["生产审批人j"].Value = SQLDatabase.nowUserName();
                }
        ...
        private void toolStripLabel4_Click(object sender, EventArgs e)
        {
            ...
            {
                toolStripLabel4.Text = "隐藏树图";
                this.splitContainer1.Panel1Collapsed = false;
            }
        }

        private void ly_sales_borrow_dateDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            if (null == ly_sales_borrow_dateDataGridView.CurrentRow)
            {

                return;
            }

            this.nowborrowcode = ly_sales_borrow_dateDataGridView.CurrentRow.Cells["借用单号a"].Value.ToString();
            ...
            if ("True" == ly_sales_borrow_dateDataGridView.CurrentRow.Cells["提交a"].Value.ToString() ||
                "True" == ly_sales_borrow_dateDataGridView.CurrentRow.Cells["批准a"].Value.ToString())
            {
                this.borrowCanchenged = "False";
            }
            else
        ...
        private void ly_sales_borrow_dateDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            DataGridView dgv = sender as DataGridView;
            ...
            if ("True" == dgv.CurrentRow.Cells["营业发货a"].Value.ToString())
            {
                MessageBox.Show("借用单已经发货,不能修改数据...", "注意");
                return;
            ...
            //if ("批准a" == dgv.CurrentCell.OwningColumn.Name)
            //{



            //    if ("True" == dgv.CurrentRow.Cells["批准a"].Value.ToString())
            //    {
            //        dgv.CurrentRow.Cells["批准a"].Value = "False";
            ...
            //        dgv.CurrentRow.Cells["批准a"].Value = "True";
            ...
            //    ly_sales_borrowDataGridView.EndEdit();
            //    //this.ly_sales_borrow_clientBindingSource.EndEdit();
            //    ly_sales_borrow_dateBindingSource.EndEdit();

            //    //NewFrm.Show(this);

            //    this.ly_sales_borrow_dateTableAdapter.Update(this.lYSalseMange2.ly_sales_borrow_date);
            ...
            //}
            /////////////////////////////////////////////////////////////////////生产审批人j
            if ("生产审批a" == dgv.CurrentCell.OwningColumn.Name)
            {
                if ("True" != dgv.CurrentRow.Cells["批准a"].Value.ToString())
                {
                    MessageBox.Show("借用单未经公司批准,不能修改数据...", "注意");
                    return;
                }


                    if ("True" == dgv.CurrentRow.Cells["生产审批a"].Value.ToString())
                {
                    dgv.CurrentRow.Cells["生产审批a"].Value = "False";
                    dgv.CurrentRow.Cells["生产审批人a"].Value = DBNull.Value;
                    dgv.CurrentRow.Cells["生产审批日期a"].Value = DBNull.Value;

                }
                else
                {

                    dgv.CurrentRow.Cells["生产审批a"].Value = "True";
                    dgv.CurrentRow.Cells["生产审批人a"].Value = SQLDatabase.nowUserName();
                    dgv.CurrentRow.Cells["生产审批日期a"].Value = SQLDatabase.GetNowdate();
                }
        ...
        //    try
        //    {
        //        this.ly_sales_borrow_dateTableAdapter.Fill(this.lYSalseMange2.ly_sales_borrow_date, new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(begindateToolStripTextBox.Text, typeof(System.DateTime))))), new System.Nullable<System.DateTime>(((System.DateTime)(System.Convert.ChangeType(enddateToolStripTextBox.Text, typeof(System.DateTime))))));
        //    }
