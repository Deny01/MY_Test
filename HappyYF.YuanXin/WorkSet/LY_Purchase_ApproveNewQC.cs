...
{
    public partial class LY_Purchase_ApproveNewQC : Form
    {

        string formState = "View";
        public LY_Purchase_ApproveNewQC()
        {
            InitializeComponent();
        }
        ...
        private void ly_purchase_contract_mainDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("审核" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if ("True" == dgv.CurrentRow.Cells["审核"].Value.ToString())
                {
                    ...
                    if (SQLDatabase.updatePurchaseContractmain(nowcontractcode, "审核", "0", DBNull.Value.ToString()))
                    {
                ...
                {
                    if (SQLDatabase.updatePurchaseContractmain(nowcontractcode, "审核", "1", SQLDatabase.nowUserName()))
                    {
