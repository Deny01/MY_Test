...
{
    public partial class LY_Production_order_Mange : Form
    {
        ...
        public LY_Production_order_Mange()
        {
            InitializeComponent();
        ...
        private void ly_production_order_materialrequisitionDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (diaodu != SQLDatabase.nowUserName() && "系统管理员" != SQLDatabase.nowUserName())
            {
                MessageBox.Show("请调度:" + diaodu + "修改", "注意");
                return;
            }
        ...
        {
            ExportDataGridviewTOExcell.ExportDataGridview(this.lY_productionorder_listDataGridView, true);
