...
{
    public partial class LY_Store_Out_Department  : Form
    {
         ...
         public LY_Store_Out_Department()
        {
            InitializeComponent();
        }
        ...
        private void ly_material_plan_mainDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            if (this.formState == "View")
            {
                ...
                else
                {
                    ...
                    this.ly_plan_getmaterial_departmentTableAdapter.Fill(this.lYPlanMange.ly_plan_getmaterial_department, "asd");
        ...
        private void CountStoreOutAuto()
        {
            ...
            cmd.CommandText = "LY_store_out_input_department_lljh";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = sqlConnection1;
        ...
        private void toolStripComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (tsc.SelectedIndex == 5)
            {
                ...
                this.label2.Visible = true;
                this.comboBox2.Visible = true;
                //this.ly_material_plan_mainBindingSource.Filter = "计划编号<='WXLL0000013'";
