...
{
    public partial class LY_RestructuringPlan_AssignTask : Form
    {

        string formState = "View";
        Point pt = new Point();

        public LY_RestructuringPlan_AssignTask()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            this.ly_restructuring_plan_detailTableAdapter.Fill(this.lYProductMange.ly_restructuring_plan_detail, int.Parse(planNum), "02");
        }
        ...
        private string GetMaxProductionorder()
        {
            ...
            cmd.Parameters["@Production_mode"].Value = "GD";
        ...
        private void SaveChanged(int gzbh)
        {
            ...
            if (null != this.ly_material_plan_mainDataGridView.CurrentRow)
            {
                ...
                this.ly_restructuring_plan_detailTableAdapter.Fill(this.lYProductMange.ly_restructuring_plan_detail, parentId, "02");
        ...
        private void ly_material_plan_mainDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            if (this.formState == "View")
            {
                ...
                else
                {
                    ...
                    this.ly_restructuring_plan_detailTableAdapter.Fill(this.lYProductMange.ly_restructuring_plan_detail, -1, "02");
