...
{
    public partial class LY_Machine_RemakeMange : Form
    {
        ...
        private void bindingNavigatorAddNewItem1_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                this.ly_production_order_remakeMenageDataGridView.CurrentRow.Cells["技术员0"].Value = SQLDatabase.nowUserName();
        ...
        private void bindingNavigatorDeleteItem1_Click(object sender, EventArgs e)
        {
            ...
            string diaodu = this.ly_production_order_remakeMenageDataGridView.CurrentRow.Cells["技术员0"].Value.ToString();

            //if (diaodu != SQLDatabase.nowUserName())
            //{
            //    MessageBox.Show("请技术员:" + diaodu + "删除", "注意");
            //    return;
            //}

            if (ly_production_order_remake_detailDataGridView.RowCount > 0)
            {
                MessageBox.Show("返修单已有工序安排,删除所有工序安排后才能删除跟单...", "注意");
                return;
        ...
        private void ly_production_order_remakeMenageDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("安排日期2" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    dgv.CurrentRow.Cells["安排日期2"].Value = queryForm.NewValue;
        ...
        private void 返修业务管理ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //}
            string nowplannum = this.ly_production_order_remakeMenageDataGridView.CurrentRow.Cells["计划编号"].Value.ToString ();
            string nowproductionorderNum = this.ly_production_order_remakeMenageDataGridView.CurrentRow.Cells["跟单编号"].Value.ToString();
            string nowitemno = this.ly_production_order_remakeMenageDataGridView.CurrentRow.Cells["物料编号"].Value.ToString();
