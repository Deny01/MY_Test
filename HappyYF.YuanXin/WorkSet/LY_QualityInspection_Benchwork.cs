...
{
    public partial class LY_QualityInspection_Benchwork : Form
    {
        public LY_QualityInspection_Benchwork()
        {
            InitializeComponent();
        }
        ...
        private void ly_production_task_waste_DataGridView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if ("打废审批" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                string   sel = "SELECT  stylecode as 编码, stylename as 原因 FROM ly_receive_repair_wastestyle ";
