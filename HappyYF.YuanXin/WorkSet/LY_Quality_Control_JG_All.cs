...
{
    public partial class LY_Quality_Control_JG_All : Form
    {
        ...
        public LY_Quality_Control_JG_All()
        {
            InitializeComponent();
        }
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            ...
            if (null == ly_production_orderDataGridView.CurrentRow && null==this.tabPage1.Parent ) return;
            if (null == lY_productionorder_listDataGridView.CurrentRow && null == this.tabPage2.Parent) return;
            ...
            {
                //if (lY_productionorder_listDataGridView.CurrentRow.Cells["总检标识2"].Value.ToString() != "True")
                //{
                //    MessageBox.Show("没有总检标识，不需总检", "注意");
            ...
            {
                //if (ly_production_orderDataGridView.CurrentRow.Cells["总检标识"].Value.ToString() != "True")
                //{
                //    MessageBox.Show("没有总检标识，不需总检", "注意");
           ...
           // string nowproductionorder = this.ly_production_orderDataGridView.CurrentRow.Cells["跟单编号"].Value.ToString();
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (!string.IsNullOrEmpty(this.ly_machinepart_process_workDataGridView.Rows[this.ly_machinepart_process_workDataGridView.RowCount - 1].Cells["返修合格"].Value.ToString()))
                {
                    remake_count = decimal.Parse(this.ly_machinepart_process_workDataGridView.Rows[this.ly_machinepart_process_workDataGridView.RowCount - 1].Cells["返修合格"].Value.ToString());
                }
                else
                {
                    remake_count = 0;
                ...
                inspect_count = qualified_count + canuse_count + remake_count;
                ...
                else
                {
                    ...
                    this.ly_production_order_inspectionAll_MainDataGridView.CurrentRow.Cells["收料数量"].Value = inspect_count - send_inspect_count;
            ...
            if ("收料数量" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    ...
                    if (send_inspect_count >= inspect_count)
                    {
                        ...
                        {
                            dgv.CurrentRow.Cells["收料数量"].Value = DBNull.Value;
                        }
                        else
                        {
            ...
            if ("送检" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                   ...
                   /////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    if (send_inspect_count- decimal.Parse(queryForm.NewValue) >= inspect_count)
                    {
                        //dgv.CurrentRow.Cells["送检"].Value = queryForm.OldValue;
...
///////////////////////////////////////////////////////////////////////////////
        ...
        private void ly_production_order_inspectionAllDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            ///////////////////////////////////////////////////////
            if ("返修合格3" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                if (queryForm.NewValue != "")
                {
                    dgv.CurrentRow.Cells["返修合格3"].Value = queryForm.NewValue;
                    ...
                    if (!CheckJudged(dgv))
                    {
                        if (string.IsNullOrEmpty(queryForm.OldValue))
                        {
                            dgv.CurrentRow.Cells["返修合格3"].Value = DBNull.Value;
                        }
                        else
                        {
                            dgv.CurrentRow.Cells["返修合格3"].Value = queryForm.OldValue;
                        }
                        return;
                    }
        ...
        private bool CheckJudged(DataGridView dgv)
        {
            ...
            if (!string.IsNullOrEmpty(dgv.CurrentRow.Cells["返修合格3"].Value.ToString()))
            {
                remake_count = decimal.Parse(dgv.CurrentRow.Cells["返修合格3"].Value.ToString());
            }
            else
            {
                remake_count = 0;
