...
{
    public partial class LY_Store_OutWaste : Form
    {
        ...
        private void LY_MaterialMange_Load(object sender, EventArgs e)
        {
            ...
            this.ly_waste_outTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            this.ly_waste_outnumDailyTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
         
           
            this.ly_waste_inoutTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;

            this.SetFormState("View");


            this.ly_waste_inoutTableAdapter.Fill(this.lYMaterialMange.ly_waste_inout ,SQLDatabase .NowUserID );
        ...
        private void toolStripTextBox1_Enter(object sender, EventArgs e)
        {
            ...
            this.ly_waste_inoutBindingSource.Filter = "";
        }
        ...
        private void toolStripTextBox1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (this.toolStripTextBox1.Text.Replace(" ", "").Length > 0)
                ...
                this.ly_waste_inoutBindingSource.Filter = dFilter;
            else
                this.ly_waste_inoutBindingSource.Filter = " ";
        }
        ...
        private void bindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                this.ly_waste_outBindingSource.RemoveCurrent();
        ...
        private void SaveStoreInDetail()
        {
            ...
            ly_waste_outBindingSource.EndEdit();
           ...
           string now_itemno;
            ...
            this.ly_waste_outTableAdapter.Update(this.lYStoreMange.ly_waste_out);
            this.ly_waste_outTableAdapter.Fill(this.lYStoreMange.ly_waste_out, nowOutNum, SQLDatabase.nowUserName());
        }
        ...
        private void bindingNavigatorDeleteItem_Click_1(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                string delstr = " delete ly_waste_out  from ly_waste_out left join ly_inma0010 on ly_waste_out.wzbh=ly_inma0010.wzbh  " +
                    " where ly_waste_out.out_number = '" + outnumber + "' and ly_inma0010.warehouse='" + storename + "'";
                ...
                this.ly_waste_outnumDailyBindingSource.RemoveCurrent();


                this.ly_waste_outnumDailyTableAdapter.Fill(this.lYStoreMange.ly_waste_outnumDaily, DateTime.Parse(this.dateTimePicker1.Text).Date, DateTime.Parse(this.dateTimePicker2.Text).Date, SQLDatabase.NowUserID);
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            this.ly_waste_outTableAdapter.Fill(this.lYStoreMange.ly_waste_out, componentNum, SQLDatabase.nowUserName());
        }
        ...
        private void bindingNavigatorAddNewItem_Click_1(object sender, EventArgs e)
        {
            ...
            this.ly_waste_outTableAdapter.Fill(this.lYStoreMange.ly_waste_out, "asd", SQLDatabase.nowUserName());
        ...
        private string GetMaxStoreOutnum()
        {
            ...
            cmd.CommandText = "LY_Get_OutNumber_Waste";
        ...
        private void ly_inma0010_inoutDataGridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            string insStr = " insert into ly_waste_out  " + "( wzbh,out_style,sub_out_style,out_number,out_date,operoter) " +
           " values ('" + componentNum + "','" + nowOutstyle+ "','" + nowSubOutstyle + "','" + nowOutNum + "','" + nowdate + "','" + SQLDatabase.nowUserName() + "' )";
            ...
            if (newFlag == "Y")
            {
                ...
                this.ly_waste_outnumDailyTableAdapter.Fill(this.lYStoreMange.ly_waste_outnumDaily, DateTime.Parse(this.dateTimePicker1.Text).Date, DateTime.Now.AddDays(1).Date, SQLDatabase.NowUserID);
                this.ly_waste_outnumDailyBindingSource.Position = this.ly_waste_outnumDailyBindingSource.Find("出库单号", nowOutNum);
                this.ly_store_outnumDailyDataGridView.SelectionChanged += ly_store_innumDataGridView_SelectionChanged;
            ...
            this.ly_waste_outTableAdapter.Fill(this.lYStoreMange.ly_waste_out, nowOutNum, SQLDatabase.nowUserName());
            this.ly_waste_outBindingSource.Position = this.ly_waste_outBindingSource.Find("物料编号", componentNum);
        }
        ...
        private void SaveInStyle(string instyle)
        {
            ...
            string delstr = " update ly_waste_out  set out_style='" + instyle + "'" +
                " from ly_waste_out left join ly_inma0010 on ly_waste_out.wzbh=ly_inma0010.wzbh " +
               " where ly_waste_out.out_number = '" + outnumber + "' and ly_inma0010.warehouse='" + storename + "'";
        ...
        private void SaveEmploye(string inemploye)
        {
            ...
            string delstr = " update ly_waste_out  set employe='" + inemploye + "'" +
                " from ly_waste_out left join ly_inma0010 on ly_waste_out.wzbh=ly_inma0010.wzbh " +
               " where ly_waste_out.out_number = '" + outnumber + "' and ly_inma0010.warehouse='" + storename + "'";
        ...
        private void SaveOriginNum(string originNum)
        {
            ...
            string delstr = " update ly_waste_out  set origin_num='" + originNum + "'" +
                " from ly_waste_out left join ly_inma0010 on ly_waste_out.wzbh=ly_inma0010.wzbh " +
               " where ly_waste_out.out_number = '" + outnumber + "' and ly_inma0010.warehouse='" + storename + "'";
        ...
        private void SaveDepartment(string inbillCode)
        {
            ...
            string delstr = " update ly_waste_out  set out_deptcode='" + inbillCode + "'" +
                " from ly_waste_out left join ly_inma0010 on ly_waste_out.wzbh=ly_inma0010.wzbh " +
               " where ly_waste_out.out_number = '" + outnumber + "' and ly_inma0010.warehouse='" + storename + "'";
        ...
        private void SaveIndate(string indate)
        {
            ...
            string delstr = " update ly_waste_out  set out_date='" + indate + "'" +
                " from ly_waste_out left join ly_inma0010 on ly_waste_out.wzbh=ly_inma0010.wzbh " +
               " where ly_waste_out.out_number = '" + outnumber + "' and ly_inma0010.warehouse='" + storename + "'";
