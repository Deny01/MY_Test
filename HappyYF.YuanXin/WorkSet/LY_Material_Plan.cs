...
{
    public partial class LY_Material_Plan : Form
    {
         string formState = "View";
        
        public LY_Material_Plan()
        {
            InitializeComponent();
        }
        ...
        {   
            ...
            this.ly_material_plan_mainTableAdapter.Fill(this.lYPlanMange.ly_material_plan_main,"WLJH");
        ...
        private string GetMaxPlanCode()
        {
            ...
            cmd.Parameters["@Plan_mode"].Value = "WLJH";
        ...
        private void 打印PToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            queryForm.Text = "中原精密物料计划需求表";

            queryForm.Printdata = this.lYPlanMange;

            queryForm.PrintCrystalReport = new LY_MaterialReport();
        ...
        private void toolStripButton6_Click(object sender, EventArgs e)
        {
            ...
            queryForm.Text = "中原精密物料计划欠料表";

            queryForm.Printdata = this.lYPlanMange;

            queryForm.PrintCrystalReport = new LY_MaterialReport_Owe();
