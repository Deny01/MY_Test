...
{
    public partial class LY_Pliers_Assembly_Out : Form
    {
        public LY_Pliers_Assembly_Out()
        {
            InitializeComponent();
        }
        ...
        private void LY_QualityInspection_Benchwork_Load(object sender, EventArgs e)
        {
            ...
            this.lY_productiontask_period_AllBindingSource.Filter = "跟单编号 like 'QZ%'";
