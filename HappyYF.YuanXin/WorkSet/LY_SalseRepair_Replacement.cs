...
{
    public partial class LY_SalseRepair_Replacement : Form
    {
        ...
        public LY_SalseRepair_Replacement()
        {
            InitializeComponent();
        }
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            {
                this.ly_sales_repair_replacementTableAdapter.Fill(this.lYSalseRepair.ly_sales_repair_replacement, this.nowusercode, this.nowfillstragecode, this.dateTimePicker1.Value, this.dateTimePicker2.Value.AddDays(1),"bill");
            }
            else
            {
                this.ly_sales_repair_replacementTableAdapter.Fill(this.lYSalseRepair.ly_sales_repair_replacement, this.nowusercode, this.nowfillstragecode, this.dateTimePicker1.Value, this.dateTimePicker2.Value.AddDays(1),"receive");
            }
