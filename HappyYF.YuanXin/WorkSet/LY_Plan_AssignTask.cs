...
{
    public partial class LY_Plan_AssignTask : Form
    {

        string formState = "View";
        Point pt = new Point();

        public LY_Plan_AssignTask()
        {
            InitializeComponent();
        ...
        private void LY_Machine_Load(object sender, EventArgs e)
        {
            ...
            // this.ly_material_plan_detailBindingSource.Filter = "oper_dept='02'";
            ...
            this.ly_material_plan_mainBindingSource1.Filter = "unfinished_count>0 and oper_dept='02' ";
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            this.ly_material_plan_mainBindingSource1.Filter = "  oper_dept='02' ";
            this.ly_material_plan_mainTableAdapter1.Fill(this.lYProductMange.ly_material_plan_main, "SCJH");

            this.toolStripButton7.Visible = true ;
        ...
        private void ly_material_plan_mainDataGridView_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            if (this.formState == "View")
            {
                ...
                if (null != this.ly_material_plan_mainDataGridView.CurrentRow)
                {
                    ...
                    this.lY_productiontask_allplanTableAdapter.Fill(this.lYProductMange.LY_productiontask_allplan, parentId, "02");
                    this.ly_material_plan_detailTableAdapter.Fill(this.lYProductMange.ly_material_plan_detail, parentId,"02");
        ...
        private string GetMaxProductionorder()
        {
            ...
            cmd.Parameters["@Production_mode"].Value = "DZ";
        ...
        private void SaveChanged()
        {
            ...
            //this.lY_productiontask_selTableAdapter.Fill(this.lYProductMange.LY_productiontask_sel, parentId, nowitem);id_d
      ...
      ////////////////////////////////////////////////////
        ...
        public void find_NowProduc(int nowplanid, string nowitemno, string nowproduction_order)
        {
            ...
            this.ly_material_plan_detailTableAdapter.Fill(this.lYProductMange.ly_material_plan_detail, nowplanid, "02");
       ...
       //////////////////////////////////////
        ...
        //    try
        //    {
        //        this.lY_TaskExplode_sumTableAdapter.Fill(this.lYPlanMange.LY_TaskExplode_sum, pruductionOrder_numToolStripTextBox.Text);
        //    }
