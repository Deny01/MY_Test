...
{
    public partial class LY_Receive_Repair_QualityIN : Form
    {
        ...
        public LY_Receive_Repair_QualityIN()
        {
            InitializeComponent();
        ...
        private void Yonghu_Load(object sender, EventArgs e)
        {
            ...
            this.ly_sales_receive_itemDetail1BindingSource.Filter = "去向  <> '维修'";
            ...
            this.ly_sales_receive_sel_newBindingSource.Filter = "返库数量 > 0 or 退库数量 > 0 ";
        ...
        private void ly_sales_receive_itemDetailDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ("维修方式" == dgv.CurrentCell.OwningColumn.Name)
            {
                ...
                sel = "SELECT  style_name as 方式  FROM ly_sales_repair_style  ";
