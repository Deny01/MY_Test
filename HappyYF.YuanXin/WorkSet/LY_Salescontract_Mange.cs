...
{
    public partial class LY_Salescontract_Mange : Form
    {
        ...
        private void ly_sales_contract_main1DataGridView_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if ("True" == ly_sales_contract_main1DataGridView.CurrentRow.Cells["借用1"].Value.ToString())
            {
                this.isborrow = "True";
            }
            else
