...
{
    public partial class LY_Material_repair : Form
    {

        string parentNum = "noSet";

        public LY_Material_repair()
        {
            InitializeComponent();
        }
        ...
        {
            this.Validate();
            this.ly_inma001011BindingSource.EndEdit();
        ...
        {
            // TODO: 这行代码将数据加载到表“lYMaterialMange.ly_inma001011”中。您可以根据需要移动或移除它。
            this.ly_inma001011TableAdapter.Fill(this.lYMaterialMange.ly_inma001011);
            ...
            this.ly_inma001011TableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            this.ly_inma001011TableAdapter.Fill(this.lYMaterialMange.ly_inma001011);
        ...
        private void toolStripTextBox1_Enter(object sender, EventArgs e)
        {
            ...
            this.ly_inma001011BindingSource.Filter = "";
        }
        ...
        private void toolStripTextBox1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            this.ly_inma001011BindingSource.Filter = filterString;
        }
