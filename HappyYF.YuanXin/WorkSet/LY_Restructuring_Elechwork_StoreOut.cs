...
{
    public partial class LY_Restructuring_Elechwork_StoreOut : Form
    {


        public LY_Restructuring_Elechwork_StoreOut()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton17_Click(object sender, EventArgs e)
        {
            ...
            queryForm.PrintCrystalReport = new LY_lingliaodan_GD();
        ...
        private void 打印PToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            queryForm.PrintCrystalReport = new LY_tuiliaodan_GD();
        ...
        private void toolStripMenuItem2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请发料人:" + ly_store_outnumDataGridView.CurrentRow.Cells["发料人22"].Value.ToString() + " 删除");
                return;
            }
