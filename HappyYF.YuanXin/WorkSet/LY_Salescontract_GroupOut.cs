...
{
    public partial class LY_Salescontract_GroupOut : Form
    {
        ...
        public LY_Salescontract_GroupOut()
        {
            InitializeComponent();
        }
        ...
        private void Yonghu_Load(object sender, EventArgs e)
        {
            ...
            this.ly_material_plan_mainperiodBindingSource.Filter = "生产审批=1";
        ...
        private void ly_material_plan_mainDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                MessageBox.Show("依赖书已经质检配调,不能修改数据...", "注意");
                return;
            ...
            /////////////////////////////////////////////////////////////////
            ///////////////////////////////////////////////////////////
            if ("出库指令0" == dgv.CurrentCell.OwningColumn.Name)
            {




                if ("True" == dgv.CurrentRow.Cells["出库指令0"].Value.ToString())
                {
                    dgv.CurrentRow.Cells["出库指令0"].Value = "False";

                }
                else
                {

                    dgv.CurrentRow.Cells["出库指令0"].Value = "True";
                }
