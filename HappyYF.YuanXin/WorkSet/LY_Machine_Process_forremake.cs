...
{
    public partial class LY_Machine_Process_forremake : Form
    {
        private int selectionIdx = 0;
        private  string formState;
        private int nowRow;

        //string remakeOrder_num;

        //public string RemakeOrder_num
        //{
        //    get { return remakeOrder_num; }
        //    set { remakeOrder_num = value; }
        //}

        int nowremakeid;

        public int Nowremakeid
        {
            get { return nowremakeid; }
            set { nowremakeid = value; }
        }
        string nowremakeOrder_num;

        public string NowremakeOrder_num
        {
            get { return nowremakeOrder_num; }
            set { nowremakeOrder_num = value; }
        }
       

        public LY_Machine_Process_forremake()
        {
            InitializeComponent();
        }
        ...
        private void LY_Machine_Process_Load(object sender, EventArgs e)
        {
            ...
            this.ly_machinepart_process_forremakeTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;

            this.groupBox1.Text ="返修单:"+nowremakeOrder_num +" :加工工序";


            this.ly_manufacturing_procedure_selTableAdapter.Fill(this.lYMaterielRequirements.ly_manufacturing_procedure_sel);

            this.ly_machinepart_process_forremakeTableAdapter.Fill(this.lYQualityInspector.ly_machinepart_process_forremake, this.nowremakeid, this.nowremakeOrder_num);
        ...
        private void ly_manufacturing_procedure_selDataGridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.ly_machinepart_process_forremakeBindingSource.AddNew();

            this.ly_machinepart_processDataGridView.CurrentRow.Cells["工序编号"].Value = sequencenumber;
            this.ly_machinepart_processDataGridView.CurrentRow.Cells["返修单号"].Value = nowremakeOrder_num ;
            this.ly_machinepart_processDataGridView.CurrentRow.Cells["顺序"].Value = this.ly_machinepart_processDataGridView.Rows.Count;
            this.ly_machinepart_processDataGridView.CurrentRow.Cells["remake_id"].Value = nowremakeid ;

            this.ly_machinepart_processDataGridView.EndEdit();
            this.ly_machinepart_process_forremakeBindingSource.EndEdit();

            this.ly_machinepart_process_forremakeTableAdapter.Update(this.lYQualityInspector.ly_machinepart_process_forremake);
        ...
        private void 删除供应商ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            string sequencenumber = this.ly_machinepart_processDataGridView.CurrentRow.Cells["顺序"].Value.ToString();
            ...
            {
                this.ly_machinepart_process_forremakeBindingSource.RemoveCurrent();
        ...
        private void SetFormState(string state)
        {
            ...
            else
            {
                ...
                this.ly_machinepart_processDataGridView.Columns["准终累加工价"].ReadOnly = true;
                this.ly_machinepart_processDataGridView.Columns["准终累加"].ReadOnly = true;
                this.ly_machinepart_processDataGridView.Columns["单件累加工价"].ReadOnly = true;
                this.ly_machinepart_processDataGridView.Columns["单件工时累加"].ReadOnly = true;
            ...
            if (this.formState != "View" && null !=dc .CurrentRow )
            {
                ...
                if (keyData == Keys.Enter)
                {
                    ...
                    if (8 == dc.CurrentCell.ColumnIndex && dc.CurrentRow.Index != (dc.RowCount - 1))
                    {
                     ...
                     else if (11 == dc.CurrentCell.ColumnIndex && dc.CurrentRow.Index != (dc.RowCount - 1))
                    {
                    ...
                    else if (14 == dc.CurrentCell.ColumnIndex && dc.CurrentRow.Index != (dc.RowCount - 1))
                    {

                        //System.Windows.Forms.SendKeys.Send("{tab}");

                        dc.EndEdit();
                        ly_machinepart_process_forremakeBindingSource.EndEdit();



                        this.ly_machinepart_process_forremakeTableAdapter.Update(this.lYQualityInspector.ly_machinepart_process_forremake);

                        ly_machinepart_process_forremakeBindingSource.Position = dc.CurrentRow.Index + 1;
                    ...
                    else
                    {
                        ...
                        if (8 == dc.CurrentCell.ColumnIndex)
                        {
                            dc.CurrentCell = dc.CurrentRow.Cells["单件工时"];


                        }
                        else if (11 == dc.CurrentCell.ColumnIndex)
                        {
                            dc.CurrentCell = dc.CurrentRow.Cells["加工说明"];
                        ...
                        else
                        {
                            ...
                            ly_machinepart_process_forremakeBindingSource.Position = 0;
