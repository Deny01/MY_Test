...
{
    public partial class LY_Quality_dzRep : Form
    {
        public LY_Quality_dzRep()
        {
            InitializeComponent();
        }
        ...
        {
            this.lY_productiontask_periodRepTableAdapter.Fill(this.lYQualityInspector.LY_productiontask_periodRep, DateTime.Parse(this.dateTimePicker1.Text).Date, DateTime.Parse(this.dateTimePicker2.Text).Date,"DZ","");
        }
