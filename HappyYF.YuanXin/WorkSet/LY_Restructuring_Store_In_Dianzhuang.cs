...
{
    public partial class LY_Restructuring_Store_In_Dianzhuang : Form
    {
        private string formState;
        string nowInNum;
        string nowdate;

        public LY_Restructuring_Store_In_Dianzhuang()
        {
            InitializeComponent();
        }
        ...
        private void CountStoreInAuto()
        {
            ...
            cmd.Parameters["@in_style"].Value = "电装改制入库"; 
