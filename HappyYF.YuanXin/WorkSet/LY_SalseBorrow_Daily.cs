...
{
    public partial class LY_SalseBorrow_Daily : Form
    {
        ...
        private void ly_sales_borrowDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                MessageBox.Show("借用已经发货,不能修改数据...", "注意");
                return;
            ...
            {
                MessageBox.Show("借用单必须经过部门审批 生产审批 后,才能执行...", "注意");
                return;
        ...
        {
            LY_BorrowPersonal_Query queryForm = new LY_BorrowPersonal_Query();
        ...
        public void find_NowBorrow(string client_num, string nowborrow)
        {

            this.tabControl1.SelectedIndex = 0;
            this.ly_sales_clientBindingSource.Position = this.ly_sales_clientBindingSource.Find("客户编码", client_num);

            this.ly_sales_borrow_clientBindingSource.Position = this.ly_sales_borrow_clientBindingSource.Find("借用单号", nowborrow);
