...
{
    public partial class LY_Salescontract_ApproveOLD : Form
    {
        ...
        public LY_Salescontract_ApproveOLD()
        {
            InitializeComponent();
        }
        ...
        private void ly_sales_contract_main1DataGridView_SelectionChanged(object sender, EventArgs e)
        {
            ...
            this.ly_sales_contract_detailTableAdapter.Fill(this.lYSalseMange.ly_sales_contract_detail, nowinnerCode, nowindex);
