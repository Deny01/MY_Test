...
{
    public partial class LY_DayGet_Plan_ForMaintenance : Form
    {
         string formState = "View";

         public LY_DayGet_Plan_ForMaintenance()
        {
            InitializeComponent();
        }
        ...
        private void LY_Material_Plan_Load(object sender, EventArgs e)
        {
            ...
            this.ly_plan_getmaterial_transferTableAdapter.Connection.ConnectionString = SQLDatabase.Connectstring;
            ...
            //if (!SQLDatabase.CheckHaveRight(SQLDatabase.NowUserID, "维修批量领料审批"))
            //{
        ...
        private string GetMaxPlanCode()
        {
            ...
            cmd.Parameters["@Plan_mode"].Value = "WXLL";
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                this.ly_material_plan_mainDataGridView.CurrentRow.Cells["制定日期"].Value =SQLDatabase.GetNowtime() ;
        ...
        private void toolStripTextBox2_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (this.toolStripTextBox2.Text.Replace(" ", "").Length > 0)
                ...
                this.lY_dayget_material_selBindingSource.Filter = dFilter;
            else
                this.lY_dayget_material_selBindingSource.Filter = " ";
        }
        ...
        private void ly_material_plan_mainDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            if (this.formState == "View")
            {
                if (null != this.ly_material_plan_mainDataGridView.CurrentRow)
                {
                    ...
                    this.ly_plan_getmaterial_transferTableAdapter.Fill(this.lYPlanMange.ly_plan_getmaterial_transfer, planNum);
        ...
        private void 删除子件ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (result1 == DialogResult.Yes)
            {
                ...
                if (1 == temp)
                {
                    ...
                    this.lY_dayget_material_selBindingSource.Position = this.lY_dayget_material_selBindingSource.Find("物资编号", componentNum);
        ...
        private void SaveChanged()
        {
            ...
            this.ly_plan_getmaterial_transferBindingSource.EndEdit();



            this.ly_plan_getmaterial_transferTableAdapter.Update(this.lYPlanMange.ly_plan_getmaterial_transfer);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            sel = "SELECT repair_sector_code as 编码, repair_sector_name as 维修部门 FROM ly_sales_repair_sectors";
            ...
            this.客户名称TextBox.Text = queryForm.Result1;
            this.客户编码TextBox.Text = queryForm.Result;
        ...
        private void 营业员Label_Click(object sender, EventArgs e)
        {
